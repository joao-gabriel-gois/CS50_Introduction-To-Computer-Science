...
int get_last_digit_for_luhn_result(int luhn_step_two_result);
...
string get_credit_card_brand(long int credit_card_number) {
  ...
  else if (visa_condition) return "VISA\n";
  else if (mastercard_condition) return "MASTERCARD\n";
...
bool check_with_algorithm_of_luhn(long int credit_card_number) {
  ...
  int last_digit = get_last_digit_for_luhn_result(luhn_result);
