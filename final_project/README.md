...
><span style="font-size: 13pt">⚠️</span><sub style="font-weight:600;font-size:11pt;"> Warning</sub>
>
> This is the version submitted to CS50. The new releases will now be pushed into  **[this <u>Repo</u>](https://github.com/joao-gabriel-gois/buzzy-paint)**.
